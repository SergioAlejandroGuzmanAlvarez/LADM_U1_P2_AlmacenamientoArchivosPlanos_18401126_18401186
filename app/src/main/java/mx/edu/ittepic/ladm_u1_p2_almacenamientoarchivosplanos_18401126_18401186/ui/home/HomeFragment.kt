package mx.edu.ittepic.ladm_u1_p2_almacenamientoarchivosplanos_18401126_18401186.ui.home
...
import mx.edu.ittepic.ladm_u1_p2_almacenamientoarchivosplanos_18401126_18401186.databinding.FragmentHomeBinding
            ...
            if (id > 0 && id < 21){
                ...
                AlertDialog.Builder(requireContext())
                    ...
                    .setPositiveButton("SI",{ d,i->
                        arreglo.eliminar(id)
                        borrarCampos()
                        Toast.makeText(context, "Fue eliminado correctamente el id", Toast.LENGTH_LONG).show()
                        d.dismiss()})
